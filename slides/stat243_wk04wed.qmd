...
## Selecting a good model is a primary task
...
MSE_full_1 <- mean( (full_pred_1 - folds_cars$splits[[1]] %>% assessment() %>% pull(FE))^2)

MSE_small_1 <- mean( (small_pred_1 - folds_cars$splits[[1]] %>% assessment() %>% pull(FE))^2)
```
