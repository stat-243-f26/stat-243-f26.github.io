...
In order to access the next two problems, clone the following repo: 


```
https://github.com/stat-243-f26/lab01_YOURGITHUBUSERNAME.git
```

From there, you can answer the questions and then commit and push your work. 
